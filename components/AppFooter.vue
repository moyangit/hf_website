      ...
      <div class="-mx-4 flex flex-wrap">
        <div class="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-4/12 xl:w-3/12">
          <div class="mb-10 w-full">
            ...
            <p class="mb-8 max-w-[270px] text-base text-gray-7 text-gray-400">
            ...
            <div class="-mx-3 flex items-center">
              <a
                href="javascript:void(0)"
                class="px-3 text-gray-700 hover:text-white"
              >
                <svg
                  width="22"
                  height="22"
          ...
          <div class="mb-10 w-full">
            ...
            <div class="flex flex-col gap-8">
              ...
              >
                ...
                <span
                  class="max-w-[180px] text-base text-gray-400 group-hover:text-white"
                >
          ...
          <div class="w-full px-4 md:w-2/3 lg:w-1/2">
            <div class="my-1">
              ...
              >
                <a
                  href="javascript:void(0)"
                  class="px-3 text-base text-gray-400 hover:text-white hover:underline"
                >
                  Privacy policy
                </a>
                <a
