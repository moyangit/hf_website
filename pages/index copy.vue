...
useHead({
  title: 'Play | Free Tailwind CSS Template for Startup and SaaS By TailGrids',
  meta: [
...
<template>
  <div class="mx-auto w-auto max-w-7xl">
      <div class="relative isolate px-6 pt-0 lg:px-8 dark:bg-gray-900">
        ...
        <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-20">
          ...
          <div class="text-center">
            <h1 class="text-5xl font-semibold tracking-tight text-balance text-gray-900 dark:text-white sm:text-7xl">Data to enrich your online business</h1>
            <p class="mt-8 text-lg font-medium text-pretty text-gray-900 dark:text-white sm:text-xl/8">Anim aute id magna aliqua ad ad non deserunt sunt. Qui irure qui lorem cupidatat commodo. Elit sunt amet fugiat veniam occaecat.</p>
            
            <div class="mt-10 flex items-center justify-center gap-x-6">
              <div
                class="w-10 h-10 transition-transform duration-300 hover:scale-110 bg-yellow-600 rounded cursor-pointer"
              >
                <img src="/images/svg/windows.svg" alt="icon" class="w-full h-full p-1" />
              </div>

              <div
                class="w-10 h-10 transition-transform duration-300 hover:scale-110 bg-yellow-600 rounded cursor-pointer"
              >
                <img src="/images/svg/andriod.svg" alt="icon" class="w-full h-full p-1" />
              </div>
            </div>

            <div class="mt-10 flex items-center justify-center gap-x-6">
              <a href="#" class="rounded-md bg-yellow-600 px-3.5 py-2.5 text-sm font-semibold text-white dark:text-white shadow-xs hover:bg-yellow-800 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Get started</a>
    ...
    <div
      id="home"
      class="p-5 md:p-20 relative overflow-hidden bg-primary pt-[120px] md:pt-[130px] lg:pt-[130px] dark:bg-gray-900 "
    >
      <div class="mx-auto w-auto p-4">
        ...
        <div class="-mx-4 flex flex-wrap">
          <div class="w-full px-4 md:w-1/2 lg:w-1/2">
            <div
                  class="hero-content wow fadeInUp text-center"
                  data-wow-delay=".2s"
                >
                  <h1
                    class="mb-4 text-2xl font-bold leading-snug text-center  text-gray-900 dark:text-white sm:text-2xl sm:leading-snug lg:text-3xl lg:leading-[1.2]"
                  >
                    Best VPN Service For You
                  </h1>
                   <h1
                    class="mb-6 text-3xl font-bold leading-snug  text-gray-900 dark:text-white sm:text-4xl sm:leading-snug lg:text-5xl lg:leading-[1.2]"
                  >
                    Fastest VPN and Proxy Solutions You Need
                  </h1>

                  <p
                    class="mx-auto mb-9 max-w-[600px] text-base font-medium text-gray-900 dark:text-white sm:text-lg sm:leading-[1.44]"
                  >
                  ...
                  >
                    <li>
                      <a
                        ...
                        class="inline-flex items-center justify-center rounded-md border border-primary bg-primary px-7 py-3 text-center text-base font-medium text-gray-900 dark:text-white hover:bg-[#0BB489]"
                      >
                        Download Now
                      </a>
                    ...
                    <li>
                      <a
                        ...
                        target="_blank"
                        class="flex items-center gap-4 rounded-md bg-white/[0.12] px-6 py-[14px] text-base font-medium text-gray-900 dark:text-white transition duration-300 ease-in-out hover:bg-white hover:text-dark"
                      >
                        <svg
                          class="fill-current"
                          width="24"
          ...
          <div class="w-full px-4 md:w-1/2 lg:w-1/2">
            <div
                  class="wow fadeInUp relative z-10 mx-auto max-w-[700px]"
                  data-wow-delay=".25s"
                >
                  <div>
                    <img
    ...
    <section class="p-5 md:p-20 pb-8 pt-20 dark:bg-dark lg:pb-[70px] lg:pt-[120px] bg-gray-100/50 dark:bg-gray-900/95 ">
      <div class="container">
        <div class="-mx-4 flex flex-wrap">
        ...
        <div class="-mx-4 flex flex-wrap">
          <div class="w-full px-4 md:w-1/2 lg:w-1/4 text-center">
            <div class="wow fadeInUp group mb-12" data-wow-delay=".1s">
              
              <div
                class="relative z-10 mb-10 flex h-[70px] w-[70px] items-center justify-center rounded-[14px] bg-blue-800 mx-auto group-hover:scale-110"
              >
                <svg
                  width="37"
                  height="37"
              ...
              <h4 class="mb-3 text-xl font-bold text-dark text-gray-900 dark:text-white">
                Free and Open-Source
              </h4>
              <p class="mb-8 lg:mb-9 text-gray-900 dark:text-white">
    ...
    <section
      id="about"
      class="p-5 md:p-20 bg-gray-1 pb-8 pt-20 dark:bg-dark-2 lg:pb-[70px] lg:pt-[120px] bg-gray-100/50 dark:bg-gray-900/90"
    >
      <div class="container">
          ...
          <div class="-mx-4 flex flex-wrap items-center">
            ...
            <div class="w-full px-4 lg:w-1/2">
              ...
              <div class="mb-12 max-w-[540px] lg:mb-0">
                ...
                >
                  We Offer The Fastest & Simplest VPN.
                  <br />
                  <br />
    ...
    <!-- ====== CTA Section Start -->
    <section
      class="p-5 md:p-20 relative z-10 overflow-hidden bg-primary py-20 lg:py-[115px] bg-gray-100/50 dark:bg-gray-900/90"
    >
          ...
          <div class="-mx-4 flex flex-wrap items-stretch">
            <div class="w-full px-4">
              <div class="mx-auto max-w-[570px] text-center">
                <h2
                  class="mb-2.5 text-3xl font-bold text-gray-900 dark:text-white md:text-[38px] md:leading-[1.44]"
                >
                  <span class="text-gray-900 dark:text-white">What Are You Looking For?</span>
                  <span class="text-3xl font-normal md:text-[40px] text-gray-900 dark:text-white">
                    Get Started Now
                  </span>
                </h2>
                <p
                  class="mx-auto mb-6 max-w-[515px] leading-[1.5] text-gray-900 dark:text-white"
                >
                ...
                <!-- <a
                  href="javascript:void(0)"
                  class="inline-block rounded-md border border-transparent bg-secondary px-7 py-3 text-base font-medium text-gray-900 dark:text-white transition hover:bg-[#0BB489]"
                >
                  Start using Play
                </a> -->
                <a
    ...
    <section
      id="pricing"
      class="p-5 md:p-20 relative z-20 overflow-hidden bg-gray-100/50 dark:bg-gray-900/90 pb-12 pt-20 dark:bg-dark lg:pb-[90px] lg:pt-[120px]"
    >
      <div class="container mx-auto">
        <div class="-mx-4 flex flex-wrap">
          <div class="w-full px-4">
            <div class="mx-auto mb-[60px] max-w-[510px] text-center">
              ...
              <p class="text-base text-body-color text-gray-900 dark:text-white">
                There are many variations of passages of Lorem Ipsum available
                but the majority have suffered alteration in some form.
              </p>
            </div>
    ...
    <!-- ====== Blog Section Start -->
    <section class="p-5 md:p-20 bg-gray-100/50 dark:bg-gray-800 pb-10 pt-20 dark:bg-dark lg:pb-20 lg:pt-[120px]">
      <div class="container mx-auto">
        <div class="-mx-4 flex flex-wrap justify-center">
          <div class="w-full px-4">
            <div class="mx-auto mb-[60px] max-w-[485px] text-center">
              ...
              <h2
                class="mb-4 text-3xl font-bold text-gray-900 dark:text-white sm:text-4xl md:text-[40px] md:leading-[1.2]"
              >
                Our Recent News
              </h2>
              <p class="text-base text-gray-900 dark:text-white">
        ...
        <div class="-mx-4 flex flex-wrap">
          <div class="w-full px-4 md:w-1/2 lg:w-1/3">
            <div class="wow fadeInUp group mb-10" data-wow-delay=".1s">
              ...
              <div>
                <span
                  class="mb-6 inline-block rounded-[5px] bg-primary px-4 py-0.5 text-center text-xs font-medium leading-loosetext-gray-900 dark:text-white"
                >
                  Dec 22, 2023
                </span>
                <h3>
                  <a
                    href="javascript:void(0)"
                    class="mb-4 inline-block text-xl font-semibold text-dark hover:text-primary text-gray-900 dark:text-white dark:hover:text-primary sm:text-2xl lg:text-xl xl:text-2xl"
                  >
                    Meet AutoManage, the best AI management tools
                  </a>
                </h3>
                <p
                  class="max-w-[370px] text-base text-gray-900 dark:text-white"
                >
            ...
            <div class="wow fadeInUp group mb-10" data-wow-delay=".15s">
              ...
              <div>
                ...
                <h3>
                  <a
                    href="javascript:void(0)"
                    class="mb-4 inline-block text-xl font-semibold hover:text-primary text-gray-900 dark:text-white dark:hover:text-primary sm:text-2xl lg:text-xl xl:text-2xl"
                  >
